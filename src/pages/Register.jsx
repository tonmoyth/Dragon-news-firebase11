...
const Register = () => {
    ...
    return (
        <div className="w-full mx-auto mt-2 max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
	...
	<p className="text-xs text-center sm:px-6 dark:text-gray-600">Already have an account?
		<Link to='/auth/login' rel="noopener noreferrer" href="#" className="underline dark:text-gray-800">Sign In</Link>
	</p>
</div>
    );
};
